...
public class VerticalStepperFormLayout extends RelativeLayout implements View.OnClickListener {
    ...
    protected boolean showConfirmationStepLayout = true;

    // Buttons Texts
    protected String confirmationButtonText;
    ...
    protected void init(Context context) {
        ...
        this.confirmationButtonText = context.getString(R.string.vertical_form_stepper_form_confirm_button);
        this.continueButtonText = context.getString(R.string.vertical_form_stepper_form_continue);
    }
    ...
    protected void initialiseVerticalStepperForm(Builder builder) {
        ...
        this.showConfirmationStepLayout = builder.showConfirmationStepLayout;
        if ( builder.continueButtonText != null ) this.continueButtonText = builder.continueButtonText;
        if ( builder.confirmationButtonText != null ) this.confirmationButtonText = builder.confirmationButtonText;
    ...
    protected void setUpSteps() {
        ...
        if ( this.showConfirmationStepLayout ) setUpStep(numberOfSteps);
        else --numberOfSteps; // Removing 1 step, cause does not exists the last one (Confirmation)
    }
    ...
    protected void setUpStep(int stepNumber) {
        ...
        if (stepNumber < numberOfSteps) {
            ...
            // This code Only run when showConfirmationStepLayout is TRUE
    ...
    protected void setUpStepLayoutAsConfirmationStepLayout(LinearLayout stepLayout) {
        ...
        confirmationButton.setText(this.confirmationButtonText);
    ...
    protected LinearLayout createStepLayout(final int stepNumber) {
        ...
        final String nextButtonTex = (stepNumber == numberOfSteps) ? confirmationButtonText : continueButtonText;
        nextButton.setText(nextButtonTex);
    ...
    public static class Builder {
        ...
        protected boolean showConfirmationStepLayout = true;
        protected String continueButtonText = null;
        protected String confirmationButtonText = null;
        ...
        /**
         * Set text value to Continue/Next button
         *
         * @param continueButtonText button text
         * @return the builder intance
         */
        public Builder continueButtonText(String continueButtonText) {
            this.continueButtonText = continueButtonText;
            return this;
        }

        /**
         * Set text value to Confirmation Button
         *
         * @param confirmationButtonText button text
         * @return the builder intance
         */
        public Builder confirmationButtonText(String confirmationButtonText) {
            this.confirmationButtonText = confirmationButtonText;
            return this;
        }

        public Builder showConfirmationStepLayout(boolean showConfirmationStepLayout) {
            this.showConfirmationStepLayout = showConfirmationStepLayout;
            return this;
        }
